...
export const DEMO_TRAINING_COURSES: TrainingCourse[] = [
  {
    id: 'course-1', title: 'IA na Prática Jurídica', description: 'Domine o uso de inteligência artificial na advocacia. Do básico ao avançado.',
  ...
  {
    id: 'course-2', title: 'Prompts Jurídicos Avançados', description: 'Aprenda a criar prompts que geram peças processuais de alta qualidade.',
...
export const DEMO_TRAINING_MODULES: TrainingModule[] = [
  {
    id: 'demo-mod-1', course_id: 'course-1', title: 'Introdução à IA para Advogados', description: 'Aprenda os fundamentos de como usar IA na prática jurídica para economizar tempo e melhorar a qualidade das peças.',
    thumbnail_url: null, sort_order: 1, lesson_count: 4, is_published: true,
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
  },
  {
    id: 'demo-mod-2', course_id: 'course-1', title: 'Prompts para Petições', description: 'Técnicas avançadas para criar prompts que geram petições iniciais, contestações e recursos.',
    thumbnail_url: null, sort_order: 2, lesson_count: 3, is_published: true,
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
  },
  {
    id: 'demo-mod-3', course_id: 'course-1', title: 'IA para Contratos e Pareceres', description: 'Como usar IA para redigir e revisar contratos e elaborar pareceres jurídicos.',
...
export const DEMO_TRAINING_LESSONS: TrainingLesson[] = [
  ...
  { id: 'lesson-3', module_id: 'demo-mod-1', title: 'Seu primeiro prompt jurídico', description: 'Criando prompts jurídicos que realmente funcionam', video_url: null, video_duration_seconds: 900, content_html: null, downloadable_files: [{ name: 'Template de prompts jurídicos', url: '#', size_bytes: 512000, type: 'pdf' }], sort_order: 3, is_published: true, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
