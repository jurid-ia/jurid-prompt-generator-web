...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-20 lg:bottom-6 right-4 z-50 flex flex-col items-end gap-2">
      ...
      <AnimatePresence>
        {tooltipVisible && (
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-xl border border-brand-gray-200/50 p-3.5 max-w-[220px]"
          >
            <button
            ...
            <p className="text-xs text-brand-black font-medium leading-snug">
              Precisa de ajuda? Fale com nosso time juridico pelo WhatsApp!
            </p>
      ...
      {/* Button */}
      <motion.a
        href="https://wa.me/5511999999999?text=Olá! Tenho interesse no Jurid IA."
        target="_blank"
