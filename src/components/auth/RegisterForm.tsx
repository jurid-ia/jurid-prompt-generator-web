    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Junte-se à nova era de ferramentas otimizadas.
        </p>
      </div>
      ...
      <Button
        type="submit"
        className="w-full bg-gradient-to-r from-brand-primary-dark to-brand-primary hover:from-brand-yellow hover:to-brand-yellow-light text-brand-black font-semibold text-lg py-6 rounded-xl shadow-lg hover:shadow-brand-yellow/30 transition-all duration-300 flex items-center justify-center group mt-2"
        size="lg"
        loading={loading}
      >
      ...
      <div className="text-center mt-8 pt-6 border-t border-white/10">
        <p className="text-gray-400 text-sm">
          ...
          <Link
            to="/login"
            className="text-white font-semibold hover:text-blue-400 transition-colors duration-200 ml-1"
          >
            Fazer login
          </Link>
        </p>
